                ...
                <div className="row">
                    <div className="col-6">
                        <ul className="list-unstyled">
                            <li><a href="#"><h4>Link utilities</h4></a></li>
                    ...
                    <div className="col-6">
                        <p>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eum deserunt minus quas magnam aliquam dolor dolorem voluptates aperiam iste. Necessitatibus fugiat aperiam impedit sapiente inventore! Dicta provident minus cumque tempore.
                        </p>
                    </div>
                </div>
